...
class ContextBuilder(object):
    ...
    def build(self, state):
        ...
        context = {
            ...
            "осужденного пол": self._gender_word(defendant_sex, "осужденного", "осужденной"),
            "осуждённого пол": self._gender_word(defendant_sex, "осуждённого", "осуждённой"),
            "осуждённую пол": self._gender_word(defendant_sex, "осуждённого", "осуждённую"),
            ...
            "способным пол": self._gender_word(defendant_sex, "способным", "способной"),
            "отказывался пол": self._gender_word(defendant_sex, "отказывался", "отказывалась"),
    ...
    def _build_intro_text(self, state):
        ...
        return (
            ...
            "при секретаре {секретарь ио bold},\n"
            "с участием:\n"
            "государственного обвинителя {гос обвинитель ио bold},\n"
        ...
        if mode == "recovery":
            if getattr(state, "defendant_objected", True):
                ...
                return (
                    ...
                    "вознаграждения адвокату, суд возлагает на {осуждённую пол} {подсудимый ио}, "
                    "{который пол} является {трудоспособным пол} и {способным пол} к возмещению судебных издержек. "
                    "Препятствия для их взыскания с {осуждённого пол} отсутствуют. Вопреки доводам "
                    "{осуждённого пол}, ни в одной из стадий производства по делу от услуг защитника "
                    "{он/она пол} не {отказывался пол}. Данных о том, что адвокаты фактически не оказывали {ему/ей пол} "
                    ...
                    "с {осуждённого пол} процессуальных издержек не является."
                )
            else:
